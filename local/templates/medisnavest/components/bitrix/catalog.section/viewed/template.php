...
<? if ($arResult['ITEMS']) { ?>
    <div class="viewed-products_section">
        <div class="container">
            <div class="viewed-products_section-header">
                <div class="section-title">Ранее вы смотрели</div>
                <div class="viewed-products_pagination js-arrows mobile-hidden">
            ...
            <div class="mobile-visible">
                <div class="viewed-products_pagination js-arrows">
                    <span class="pagination-number"></span>
                    <span class="divider">/</span>
                    <span class="pagination-digit"></span>
                </div>
